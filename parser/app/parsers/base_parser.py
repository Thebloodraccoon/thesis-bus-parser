...
from parser.app.db.city_db import logger
from parser.app.managers.http import send_request, get_response_size
...
from parser.app.settings.conf import ua, get_db
