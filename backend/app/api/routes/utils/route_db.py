...
from backend.app.api.models import TripModel, RouteModel, SiteModel, CityModel
from backend.app.api.routes.schema import TripSchemaResponse, RouteSchema
from backend.app.api.routes.utils.data_processing import create_route_entry, initialize_route_by_cities_result, \
    add_route_for_date, process_trips_result, process_routes_result
from backend.app.api.routes.utils.query_builders import get_available_sites, build_latest_history_subquery, \
