...
<template>
    <div class="sites-list">
        ...
        <div class="flex flex-wrap gap-2 items-center justify-between mb-3">
            ...
            <Button v-if="isAdmin" type="button" icon="pi pi-plus" label="Add site" @click="goToCreate" class="p-button-success" />
        </div>
        ...
        >
            ...
            <Column field="last_parsed" header="Last data collection" sortable :style="{ width: '25%' }">
                <template #body="{ data }">
