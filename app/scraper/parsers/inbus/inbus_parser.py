...
from app.scraper.parsers.inbus.inbus_helper import get_cookies, get_request_url, parse_trip_data
...
class InbusParser(RequestParser):
    ...
    async def init_async(self):
        self.cookies = await get_cookies("https://inbus.ua/")
    ...
    async def get_content(
        ...
        **kwargs,
        ...
        url_token = await get_request_url()
