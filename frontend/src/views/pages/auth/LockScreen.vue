...
<template>
    <div :class="'login-body flex min-h-screen  ' + (isDarkTheme ? 'layout-dark' : 'layout-light')">
        <div class="login-image w-6/12 h-screen hidden md:block" style="max-width: 490px">
            <img :src="'/demo/images/pages/lock-' + (isDarkTheme ? 'ondark' : 'onlight') + '.png'" alt="atlantis" class="h-screen w-full" />
        </div>
        <div class="w-full" style="background: var(--surface-ground)">
            <Fluid class="Fluid min-h-screen text-center w-full flex items-center md:items-start justify-center flex-col bg-auto md:bg-contain bg-no-repeat" style="padding: 20% 10% 20% 10%; background: var(--exception-pages-image)">
                <div class="flex flex-col">
                    ...
                    <div class="form-container text-left" style="max-width: 320px; min-width: 270px">
                        <div class="mb-6 flex flex-col items-start">
                            ...
                            <img src="/demo/images/pages/avatar.png" class="w-12 h-12 mb-2" alt="Avatar" />
                            <span class="font-medium text-surface-900 dark:text-surface-0">Isabella Andolini</span>
                        </div>
                        <IconField>
                            <InputIcon class="pi pi-key" />
                            <InputText type="password" autocomplete="off" placeholder="Password" class="block mb-4" style="max-width: 320px; min-width: 270px" />
                        </IconField>
                    </div>
